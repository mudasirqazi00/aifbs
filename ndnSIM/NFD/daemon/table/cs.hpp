...
#include "../src/ndnSIM/NFD/daemon/table/bs/BTree.hpp"
#include "../src/ndnSIM/NFD/daemon/table/bs/BTree.cpp"
#include "../src/ndnSIM/NFD/daemon/table/bs/FileNodeKey.cpp"
#include "../src/ndnSIM/NFD/daemon/table/bs/ChunkNodeKey.cpp"
#include "../src/ndnSIM/NFD/daemon/table/bs/SplittedNames.cpp"
...
public:
	ChunkNodeKey* findInCsTree(std::string t_name) const;
	bool insertInCsTree(std::string t_name, EntryImpl* entryImpl);
	SplittedNames split(std::string name) const;
	SplittedNames splitit(std::string name) const;
	int treeSize();
