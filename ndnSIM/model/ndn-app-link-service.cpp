...
AppLinkService::doSendInterest(const Interest& interest)
{
  ...
  //LogManager::AddLogWithNodeId("ndn-app-link-service.cpp->doSendInterest.name", interest.getName().toUri());
...
AppLinkService::doSendData(const Data& data)
{
  ...
  //LogManager::AddLogWithNodeId("ndn-app-link-service.cpp->doSendData.name", data.getName().toUri());
