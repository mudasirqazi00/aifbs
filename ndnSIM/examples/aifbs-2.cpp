...
//	randomizer->SetAttribute("Max", DoubleValue(100));
	...
	positionAlloc->Add(Vector(130.0, 50.0, 0.0));
	positionAlloc->Add(Vector(260, 0.0, 0.0));
	positionAlloc->Add(Vector(390, 50.0, 0.0));
	positionAlloc->Add(Vector(520, 0.0, 0.0));
	...
	producerHelper1.SetPrefix("/test/");
