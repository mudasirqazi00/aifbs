...
//  LogManager::AddLogWithNodeId("ndn-app.cpp->OnInterest.start");
//  LogManager::AddLogWithNodeId("ndn-app.cpp->OnInterest.name", interest->getName().toUri());
...
//  LogManager::AddLogWithNodeId("ndn-app.cpp->OnInterest.completed");
}
...
//  LogManager::AddLogWithNodeId("ndn-app.cpp->OnData.start");
//  LogManager::AddLogWithNodeId("ndn-app.cpp->OnData.name", data->getName().toUri());
  m_receivedDatas(data, this, m_face);
//  LogManager::AddLogWithNodeId("ndn-app.cpp->OnData.completed");
}
